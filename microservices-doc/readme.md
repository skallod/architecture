...
- [Auth service](#auth-service) 
  * [Entities](#entities-7)
  * [Rest](#rest-6)
- [Promocode service](#Promocode-service)
  * [Entities](#entities-8)
  * [Rest](#rest-7)
...
![Alt text](pictures/store-microservice.png?raw=true "Title")

## Временная диаграмма создания заказа
./pictures/store-order-time-diagram.png
![Alt text](pictures/store-order-time-diagram.png?raw=true "Title")
...
, в таком случае booked event отбрасывается - предполагается что pay_pending_event не может придти в
случае, когда продукты не забронированы.  
