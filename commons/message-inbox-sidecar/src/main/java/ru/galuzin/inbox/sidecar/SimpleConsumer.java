package ru.galuzin.inbox.sidecar;
...
//        }
        ...
        final String topicName = "annotated1";//args[0].toString();
        final String groupId = "inbox-group4";//args[1].toString();
        final String clientId = "inbox-id4";//args[2].toString();
